<?php
	...
	*/
	...
	$jokes = [
		["q"=>"What do you call a very small valentine?","a"=>"A valen-tiny! (heroku)"],
		["q"=>"What did the dog say when he rubbed his tail on the sandpaper?","a"=>"Ruff, Ruff! (heroku)"],
		["q"=>"Why don't sharks like to eat clowns?","a"=>"Because they taste funny! (heroku)"],
		["q"=>"What did the boy cat say to the girl cat?","a"=>"You're Purr-fect! (heroku)"],
		["q"=>"What is a frog's favorite outdoor sport?","a"=>"Fly Fishing! (heroku)"],
		["q"=>"I hate jokes about German sausages.","a"=>"Theyre the wurst. (heroku)"],
		["q"=>"Did you hear about the cheese factory that exploded in France?","a"=>"There was nothing left but de Brie. (heroku)"],
		["q"=>"Our wedding was so beautiful ","a"=>"Even the cake was in tiers. (heroku)"],
		["q"=>"Is this pool safe for diving?","a"=>"It deep ends. (heroku)"],
		["q"=>"Dad, can you put my shoes on?","a"=>"I dont think theyll fit me. (heroku)"],
		["q"=>"Can February March?","a"=>"No, but April May (heroku)"],
		["q"=>"What lies at the bottom of the ocean and twitches?","a"=>"A nervous wreck. (heroku)"],
		["q"=>"Im reading a book on the history of glue.","a"=>"I just cant seem to put it down. (heroku)"],
		["q"=>"Dad, can you put the cat out?","a"=>"I didnt know it was on fire. (heroku)"],
		["q"=>"What did the ocean say to the sailboat?","a"=>"Nothing, it just waved. (heroku)"],
		["q"=>"What do you get when you cross a snowman with a vampire?","a"=>"Frostbite (heroku)"]
	];
